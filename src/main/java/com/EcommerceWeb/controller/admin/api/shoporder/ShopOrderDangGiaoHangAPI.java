...
@WebServlet(urlPatterns = {"/api-admin-shop-order-dang-giao-hang"})

public class ShopOrderDangGiaoHangAPI extends HttpServlet {
    @Inject
     ...
     //   super.doPost(req, resp);
        ...
        try{
            ...
            if(shopOrderModel==null){
                ...
                shopOrderModel.setOrderStatusID(4);
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            ...
            if(shopOrderModel==null){
                ...
                if(success){
                    shopOrderModel.setOrderStatusID(3);
                    shopOrderDAO.update(shopOrderModel);
