        ...
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
            <div class="tm-bg-primary-dark tm-block tm-block-h-auto" style="padding: 5% 3%;">
                    ...
                    <c:choose>
                        <c:when test="${type==1}">
                            <div class="col-12" style="margin-left: 5%;">
                                <h2 class="tm-block-title d-inline-block text-uppercase">THÊM SIZE</h2>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <div class="col-12" style="margin-left: 5%;">
                                <h2 class="tm-block-title d-inline-block text-uppercase">THÊM MÀU</h2>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
                ...
                <form class="row tm-edit-product-row col-12" style="margin: 0;"
                      id="productForm" action="<c:url value='/admin-addSize/${url}'/>" method="post">
